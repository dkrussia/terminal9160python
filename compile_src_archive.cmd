...
tar -acf 9160-service-%env_mode%.zip base dashboard services utils config.py main.py requirements.txt run.cmd open_config_file.cmd install_requirements_offline.cmd packages.zip
